        ...
        switch (code) {
            ...
            case ADD_APP_TASK_TRANSACTION: {
                ...
                android.app.ActivityManager.TaskDescription descr
                        = android.app.ActivityManager.TaskDescription.CREATOR.createFromParcel(data);
            ...
            case GET_TASKS_TRANSACTION: {
                ...
                int fl = data.readInt();
                List<android.app.ActivityManager.RunningTaskInfo> list = getTasks(maxNum, fl);
                reply.writeNoException();
                int N = list != null ? list.size() : -1;
                reply.writeInt(N);
                int i;
            ...
            case GET_RECENT_TASKS_TRANSACTION: {
                ...
                int fl = data.readInt();
                int userId = data.readInt();
                List<android.app.ActivityManager.RecentTaskInfo> list = getRecentTasks(maxNum,
                        fl, userId);
                reply.writeNoException();
            ...
            case GET_SERVICES_TRANSACTION: {
                ...
                int maxNum = data.readInt();
                int fl = data.readInt();
                List<android.app.ActivityManager.RunningServiceInfo> list = getServices(maxNum, fl);
                reply.writeNoException();
                int N = list != null ? list.size() : -1;
                reply.writeInt(N);
                int i;
            ...
            case GET_PROCESSES_IN_ERROR_STATE_TRANSACTION: {
                data.enforceInterface(IActivityManager.descriptor);
                List<android.app.ActivityManager.ProcessErrorStateInfo> list = getProcessesInErrorState();
                reply.writeNoException();
                reply.writeTypedList(list);
                return true;
            }
            ...
            case GET_RUNNING_APP_PROCESSES_TRANSACTION: {
                data.enforceInterface(IActivityManager.descriptor);
                List<android.app.ActivityManager.RunningAppProcessInfo> list = getRunningAppProcesses();
                reply.writeNoException();
                reply.writeTypedList(list);
                return true;
            }
...
class ActivityManagerProxy implements IActivityManager {
    ...
    public List<android.app.ActivityManager.RunningTaskInfo> getTasks(int maxNum, int flags)
            throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        ...
        reply.readException();
        ArrayList<android.app.ActivityManager.RunningTaskInfo> list = null;
        int N = reply.readInt();
        if (N >= 0) {
            list = new ArrayList<>();
            while (N > 0) {
                android.app.ActivityManager.RunningTaskInfo info =
                        android.app.ActivityManager.RunningTaskInfo.CREATOR
    ...
    public List<android.app.ActivityManager.RecentTaskInfo> getRecentTasks(int maxNum,
        ...
        reply.readException();
        ArrayList<android.app.ActivityManager.RecentTaskInfo> list
                = reply.createTypedArrayList(android.app.ActivityManager.RecentTaskInfo.CREATOR);
        data.recycle();
        reply.recycle();
        return list;
    }

    public android.app.ActivityManager.TaskThumbnail getTaskThumbnail(int id) throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeInt(id);
    ...
    public List<android.app.ActivityManager.RunningServiceInfo> getServices(int maxNum, int flags)
            throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        ...
        reply.readException();
        ArrayList<android.app.ActivityManager.RunningServiceInfo> list = null;
        int N = reply.readInt();
        if (N >= 0) {
            list = new ArrayList<>();
            while (N > 0) {
                android.app.ActivityManager.RunningServiceInfo info =
                        android.app.ActivityManager.RunningServiceInfo.CREATOR
                                .createFromParcel(reply);
                list.add(info);
                N--;
            }
    ...
    public List<android.app.ActivityManager.ProcessErrorStateInfo> getProcessesInErrorState()
        ...
        reply.readException();
        ArrayList<android.app.ActivityManager.ProcessErrorStateInfo> list
                = reply.createTypedArrayList(android.app.ActivityManager.ProcessErrorStateInfo.CREATOR);
        data.recycle();
        reply.recycle();
        return list;
    }
    ...
    public List<android.app.ActivityManager.RunningAppProcessInfo> getRunningAppProcesses()
        ...
        reply.readException();
        ArrayList<android.app.ActivityManager.RunningAppProcessInfo> list
                = reply.createTypedArrayList(android.app.ActivityManager.RunningAppProcessInfo.CREATOR);
        data.recycle();
        reply.recycle();
        return list;
    }
